function [c,ceq] = ex4_mycon(u,pcesysH,pcesysM,simoptions)
 simH = PoCETsimGalerkin(pcesysH,'ex4_ODE_H',[],simoptions,'u1_v',u); % simulate system H
 ...
 simM = PoCETsimGalerkin(pcesysM,'ex4_ODE_M',[],simoptions,'u1_v',u); % simulate system M
